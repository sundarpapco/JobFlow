...
import com.sivakasi.papco.jobflow.screens.manageprintorder.printingDetails.PrintingDetailsScreen
...
@AndroidEntryPoint
class FragmentPrintingDetail : Fragment() {
            ...
            setContent {
                JobFlowTheme {
                    PrintingDetailsScreen(
                        ...
                        onNext = {
                            findNavController()
                                .navigate(R.id.action_fragmentPrintingDetail_to_composeFragmentPostPressDetails)
                        },
